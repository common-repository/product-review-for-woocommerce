...
v1.0.3
*/
if(!class_exists('pisol_product_review_plugin_review')){
class pisol_product_review_plugin_review{
...
new pisol_product_review_plugin_review('Customer review for WooCommerce', 'product-review-for-woocommerce');
}